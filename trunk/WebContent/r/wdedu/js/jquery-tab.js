	...
	$.extend({
        ...
        $sections.each(function(i,item) {
          if ($(this).attr("title") && $(this).attr("id")) {
            tabHTML += '<li><a onclick="'+'tt'+i+'()'+'"  href="#' + $(this).attr("id") + '">' + $(this).attr("title") + '</a></li>';
          }
        });
        tabHTML += '</ul>';
        ...
        var activateTab = function(id) {
          $tabs.filter('.active2').removeClass('active2');
          $sections.filter('.active2').removeClass('active2');
          $tabs.has('a[href="' + id + '"]').addClass('active2');
          $sections.filter(id).addClass('active2');
        }
