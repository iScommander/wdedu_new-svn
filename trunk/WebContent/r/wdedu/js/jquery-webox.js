...
$.extend({
	webox:function(option){
		...
		$(document).ready(function(e){
			...
			$('body').append('<div class="background" style="display:none;"></div><div class="webox" style="width:'+90+'%;height:'+90+'%;display:none;"><div id="inside" style="height:'+100+'%;"><h1 id="locked" onselectstart="return false;">'+(option['title']?option['title']:'webox')+'<a class="span" href="javascript:void(0);"></a></h1>'+(option['iframe']?'<iframe class="w_iframe" src="'+option['iframe']+'" frameborder="0" width="100%" scrolling="no" style="border:none;overflow-x:hidden;height:'+100+'%;"></iframe>':option['html']?option['html']:'')+'</div></div>');
