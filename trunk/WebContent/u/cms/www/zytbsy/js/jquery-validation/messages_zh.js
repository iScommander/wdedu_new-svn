...
//(function () {
//    function a(b) { return b.replace(/<.[^<>]*?>/g, " ").replace(/&nbsp;|&#160;/gi, " ").replace(/[0-9.(),;:!?%#$'"_+=\/-]*/g, "") }
//    jQuery.validator.addMethod("maxWords", function (b, c, d) { return this.optional(c) || a(b).match(/\b\w+\b/g).length < d },
...
(function (factory) {
    ...
    jQuery.validator.addMethod("prot", function (value, element) { var length = value.length; return this.optional(element) || /^(1)*$/.test(value); }, "概率和必须等于1");
}));
