...
public class FrameAct {
	...
	/**运营管理*/
	@RequiresPermissions("frame:master_main")
	@RequestMapping("/frame/master_main.do")
	public String masterMain(ModelMap model) {
		return "frame/master_main";
	}

	@RequiresPermissions("frame:master_left")
	@RequestMapping("/frame/master_left.do")
	public String masterLeft(ModelMap model) {
		return "frame/master_left";
	}

	@RequiresPermissions("frame:master_right")
	@RequestMapping("/frame/master_right.do")
	public String masterRight(ModelMap model) {
		return "frame/master_right";
	}
