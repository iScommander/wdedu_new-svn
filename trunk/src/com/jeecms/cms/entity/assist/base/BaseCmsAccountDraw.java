...
public abstract class BaseCmsAccountDraw  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsAccountDraw)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsAccountDraw cmsAccountDraw = (com.jeecms.cms.entity.assist.CmsAccountDraw) obj;
			if (null == this.getId() || null == cmsAccountDraw.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsAccountDraw.getId()));
            }
		}
	}
