...
public abstract class BaseCmsAcquisitionHistory  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsAcquisitionHistory)) {
            return false;
        } else {
			...
			if (null == this.getId() || null == cmsAcquisitionHistory.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsAcquisitionHistory.getId()));
            }
		}
	}
