...
public abstract class BaseCmsAcquisitionTemp  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsAcquisitionTemp)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsAcquisitionTemp cmsAcquisitionTemp = (com.jeecms.cms.entity.assist.CmsAcquisitionTemp) obj;
			if (null == this.getId() || null == cmsAcquisitionTemp.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsAcquisitionTemp.getId()));
            }
		}
	}
