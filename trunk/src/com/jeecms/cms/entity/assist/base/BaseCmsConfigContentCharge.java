...
public abstract class BaseCmsConfigContentCharge  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsConfigContentCharge)) {
            return false;
        } else {
			...
			if (null == this.getId() || null == cmsConfigContentCharge.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsConfigContentCharge.getId()));
            }
		}
	}
