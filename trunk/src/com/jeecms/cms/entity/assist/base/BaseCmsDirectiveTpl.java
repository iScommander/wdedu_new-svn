...
public abstract class BaseCmsDirectiveTpl  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsDirectiveTpl)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsDirectiveTpl cmsDirectiveTpl = (com.jeecms.cms.entity.assist.CmsDirectiveTpl) obj;
			if (null == this.getId() || null == cmsDirectiveTpl.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsDirectiveTpl.getId()));
            }
		}
	}
