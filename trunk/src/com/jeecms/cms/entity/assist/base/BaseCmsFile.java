...
public abstract class BaseCmsFile  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsFile)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsFile cmsFile = (com.jeecms.cms.entity.assist.CmsFile) obj;
			if (null == this.getFilePath() || null == cmsFile.getFilePath()) {
                return false;
            } else {
                return (this.getFilePath().equals(cmsFile.getFilePath()));
            }
		}
	}
