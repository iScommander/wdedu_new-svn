...
public abstract class BaseCmsGuestbookCtg  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsGuestbookCtg)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsGuestbookCtg cmsGuestbookCtg = (com.jeecms.cms.entity.assist.CmsGuestbookCtg) obj;
			if (null == this.getId() || null == cmsGuestbookCtg.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsGuestbookCtg.getId()));
            }
		}
	}
