...
public abstract class BaseCmsReceiverMessage  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsReceiverMessage)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsReceiverMessage cmsReceiverMessage = (com.jeecms.cms.entity.assist.CmsReceiverMessage) obj;
			if (null == this.getId() || null == cmsReceiverMessage.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsReceiverMessage.getId()));
            }
		}
	}
