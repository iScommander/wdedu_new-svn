...
public abstract class BaseCmsScoreRecord  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsScoreRecord)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsScoreRecord cmsScoreRecord = (com.jeecms.cms.entity.assist.CmsScoreRecord) obj;
			if (null == this.getId() || null == cmsScoreRecord.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsScoreRecord.getId()));
            }
		}
	}
