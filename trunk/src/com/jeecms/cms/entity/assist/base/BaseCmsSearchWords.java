...
public abstract class BaseCmsSearchWords  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsSearchWords)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsSearchWords cmsSearchWords = (com.jeecms.cms.entity.assist.CmsSearchWords) obj;
			if (null == this.getId() || null == cmsSearchWords.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsSearchWords.getId()));
            }
		}
	}
