...
public abstract class BaseCmsSensitivity  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsSensitivity)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsSensitivity cmsSensitivity = (com.jeecms.cms.entity.assist.CmsSensitivity) obj;
			if (null == this.getId() || null == cmsSensitivity.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsSensitivity.getId()));
            }
		}
	}
