...
public abstract class BaseCmsSiteAccessCount  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsSiteAccessCount)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsSiteAccessCount cmsSiteAccessCount = (com.jeecms.cms.entity.assist.CmsSiteAccessCount) obj;
			if (null == this.getId() || null == cmsSiteAccessCount.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsSiteAccessCount.getId()));
            }
		}
	}
