...
public abstract class BaseCmsSiteAccessPages  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsSiteAccessPages)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsSiteAccessPages cmsSiteAccessPages = (com.jeecms.cms.entity.assist.CmsSiteAccessPages) obj;
			if (null == this.getId() || null == cmsSiteAccessPages.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsSiteAccessPages.getId()));
            }
		}
	}
