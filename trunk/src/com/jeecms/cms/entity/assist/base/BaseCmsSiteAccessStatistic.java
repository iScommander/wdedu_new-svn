...
public abstract class BaseCmsSiteAccessStatistic  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsSiteAccessStatistic)) {
            return false;
        } else {
			...
			if (null == this.getId() || null == cmsSiteAccessStatistic.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsSiteAccessStatistic.getId()));
            }
		}
	}
