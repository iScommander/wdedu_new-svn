...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsVoteSubTopic)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (com.jeecms.cms.entity.assist.CmsVoteSubTopic) obj;
			if (null == this.getId() || null == cmsVoteSubTopic.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsVoteSubTopic.getId()));
            }
		}
	}
