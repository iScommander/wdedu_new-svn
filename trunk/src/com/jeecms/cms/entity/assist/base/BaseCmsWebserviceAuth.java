...
public abstract class BaseCmsWebserviceAuth  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsWebserviceAuth)) {
            return false;
        } else {
			com.jeecms.cms.entity.assist.CmsWebserviceAuth cmsWebserviceAuth = (com.jeecms.cms.entity.assist.CmsWebserviceAuth) obj;
			if (null == this.getId() || null == cmsWebserviceAuth.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsWebserviceAuth.getId()));
            }
		}
	}
