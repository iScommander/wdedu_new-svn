...
public abstract class BaseCmsWebserviceCallRecord  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.assist.CmsWebserviceCallRecord)) {
            return false;
        } else {
			...
			if (null == this.getId() || null == cmsWebserviceCallRecord.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsWebserviceCallRecord.getId()));
            }
		}
	}
