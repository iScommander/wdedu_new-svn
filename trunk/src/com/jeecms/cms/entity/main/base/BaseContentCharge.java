...
public abstract class BaseContentCharge  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.main.ContentCharge)) {
            return false;
        } else {
			com.jeecms.cms.entity.main.ContentCharge cmsContentCharge = (com.jeecms.cms.entity.main.ContentCharge) obj;
			if (null == this.getId() || null == cmsContentCharge.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsContentCharge.getId()));
            }
		}
	}
