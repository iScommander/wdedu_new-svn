...
public abstract class BaseCmsUserAccount  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.core.entity.CmsUserAccount)) {
            return false;
        } else {
			com.jeecms.core.entity.CmsUserAccount cmsUserContentCharge = (com.jeecms.core.entity.CmsUserAccount) obj;
			if (null == this.getId() || null == cmsUserContentCharge.getId()) {
                return false;
            } else {
                return (this.getId().equals(cmsUserContentCharge.getId()));
            }
		}
	}
