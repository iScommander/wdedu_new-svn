...
public abstract class BasePlugStoreConfig  implements Serializable {
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.plug.store.entity.PlugStoreConfig)) {
            return false;
        } else {
			com.jeecms.plug.store.entity.PlugStoreConfig plugStoreConfig = (com.jeecms.plug.store.entity.PlugStoreConfig) obj;
			if (null == this.getId() || null == plugStoreConfig.getId()) {
                return false;
            } else {
                return (this.getId().equals(plugStoreConfig.getId()));
            }
		}
	}
