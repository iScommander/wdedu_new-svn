...
public abstract class BaseWeixinMenu  implements Serializable {
	...
	public void addTochild (com.jeecms.plug.weixin.entity.WeixinMenu weixinMenu) {
		if (null == getChild()) {
            setChild(new java.util.TreeSet<com.jeecms.plug.weixin.entity.WeixinMenu>());
        }
    ...
    public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.plug.weixin.entity.WeixinMenu)) {
            return false;
        } else {
			com.jeecms.plug.weixin.entity.WeixinMenu weixinMenu = (com.jeecms.plug.weixin.entity.WeixinMenu) obj;
			if (null == this.getId() || null == weixinMenu.getId()) {
                return false;
            } else {
                return (this.getId().equals(weixinMenu.getId()));
            }
		}
	}
