...
public class TBaseProvince {
    ...
    private Integer subjectsModel;
    private Integer ceeExamsModel;
    private Integer limitlitModel;
    ...
    public boolean equals(Object o) {
        ...
        TBaseProvince that = (TBaseProvince) o;
    ...
    @Basic
    @Column(name = "subjects_model")
    public Integer getSubjectsModel() {
        return subjectsModel;
    }

    public void setSubjectsModel(Integer subjectsModel) {
        this.subjectsModel = subjectsModel;
    }

    @Basic
    @Column(name = "ceeExams_model")
    public Integer getCeeExamsModel() {
        return ceeExamsModel;
    }

    public void setCeeExamsModel(Integer ceeExamsModel) {
        this.ceeExamsModel = ceeExamsModel;
    }

    @Basic
    @Column(name = "limitlit_model")
    public Integer getLimitlitModel() {
        return limitlitModel;
    }

    public void setLimitlitModel(Integer limitlitModel) {
        this.limitlitModel = limitlitModel;
    }
}
