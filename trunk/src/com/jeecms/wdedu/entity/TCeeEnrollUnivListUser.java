...
@Entity
@Table(name = "t_cee_enroll_univ_list_user", schema = "wodecareer", catalog = "")
public class TCeeEnrollUnivListUser {
...
//    @SequenceGenerator(name="id",sequenceName="S_QUENSE",allocationSize=1)
    ...
    public boolean equals(Object o) {
        ...
        TCeeEnrollUnivListUser that = (TCeeEnrollUnivListUser) o;
